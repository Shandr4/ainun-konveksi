...
<body class="antialiased text-slate-800">
    ...
    <section class="py-16 md:py-24 px-4 md:px-20 bg-slate-50">
        <div class="max-w-7xl mx-auto text-center mb-10 md:mb-16">
            <h2 class="text-3xl md:text-4xl font-black text-[#4A699C] mb-3 md:mb-4 uppercase tracking-tighter">Layanan Konveksi Anjaya</h2>
    ...
    <section class="py-16 md:py-24 px-4 md:px-20 bg-white overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-10 md:gap-12 relative z-10 text-center">
                <div class="flex flex-col items-center max-w-[250px] bg-white px-4">
                    <div class="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#FCA311] text-white flex items-center justify-center text-2xl md:text-3xl font-black mb-4 md:mb-6 shadow-xl border-4 border-white">1</div>
                    <h4 class="font-bold text-[#4A699C] text-base md:text-lg mb-2">Konsultasi</h4>
                    <p class="text-xs text-slate-500 leading-relaxed">Diskusi kebutuhan dan spesifikasi produk Anda</p>
                </div>
                <div class="flex flex-col items-center max-w-[250px] bg-white px-4">
                    <div class="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#FCA311] text-white flex items-center justify-center text-2xl md:text-3xl font-black mb-4 md:mb-6 shadow-xl border-4 border-white">2</div>
                ...
                <div class="flex flex-col items-center max-w-[250px] bg-white px-4">
                    <div class="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#FCA311] text-white flex items-center justify-center text-2xl md:text-3xl font-black mb-4 md:mb-6 shadow-xl border-4 border-white">3</div>
    ...
    <section id="cta-box" class="pb-16 md:pb-24 px-4 md:px-20 bg-white">
        <div class="max-w-5xl mx-auto bg-[#4A699C] rounded-[30px] md:rounded-[40px] p-8 md:p-20 text-center shadow-2xl relative overflow-hidden text-white">
            ...
            <div class="relative z-10">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-black mb-3 md:mb-4">Siap Memulai Proyek Anda?</h2>
    ...
    <footer class="bg-[#4A699C] py-16 md:py-20 px-6 md:px-20 border-t border-white/10 mt-10">
        ...
        <div class="max-w-7xl mx-auto border-t border-white/20 mt-12 md:mt-16 pt-8 text-center text-white/50 text-xs md:text-sm font-medium">
